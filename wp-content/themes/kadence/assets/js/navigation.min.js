    ...
    window.kadence = {
            ...
            if (t.length)
                for (let a = 0; a < t.length; a++) {
                    ...
                    if (o.querySelector(".dropdown-nav-toggle")) {
                        ...
                        i.setAttribute("aria-label", n ? kadenceConfig.screenReader.expandOf + " " + n : kadenceConfig.screenReader.expand), i.classList.add("dropdown-nav-special-toggle"), e ? e.insertBefore(i, e.childNodes[1]) : o.insertBefore(i, o.childNodes[1]), i.addEventListener("click", (function(e) {
        ...
        toggleSubMenu: function(e, t) {
            ...
            if (void 0 !== t && "boolean" == typeof t && (i = !t), o.setAttribute("aria-expanded", (!i).toString()), i) {
                ...
                var s = e.parentNode.querySelectorAll("li.menu-item--toggled-on");
                for (let e = 0; e < s.length; e++) window.kadence.toggleSubMenu(s[e], !1);
        ...
        initStickyHeader: function() {
            var e = document.querySelector("#main-header .kadence-sticky-header"),
                ...
                r = 0,
                s = 0;
            parseInt(kadenceConfig.breakPoints.desktop) < window.innerWidth ? (a = "desktop", e && (e.style.position = "static", s = window.kadence.getOffset(e).top, e.style.position = null)) : t && (t.style.position = "static", s = window.kadence.getOffset(t).top, t.style.position = null);
            var d, l, c, u = function(d) {
                ...
                if (l = kadenceConfig.breakPoints.desktop <= window.innerWidth ? e : t) {
                    kadenceConfig.breakPoints.desktop <= window.innerWidth ? "mobile" === a ? (s = window.kadence.getOffset(l).top, a = "desktop") : d && "updateActive" === d && (l.style.top = "auto", s = window.kadence.getOffset(l).top, a = "desktop") : "desktop" === a ? (s = window.kadence.getOffset(l).top, a = "mobile") : d && "updateActive" === d && (l.style.top = "auto", s = window.kadence.getOffset(l).top, a = "mobile");
                    var h = l.parentNode,
                        w = l.getAttribute("data-shrink"),
                        m = l.getAttribute("data-reveal-scroll-up"),
                        p = parseInt(l.getAttribute("data-start-height"));
                    if ((!p || d && void 0 !== d.type && "orientationchange" === d.type) && (l.setAttribute("data-start-height", l.offsetHeight), p = l.offsetHeight, h.classList.contains("site-header-upper-inner-wrap") ? (h.style.height = null, d && void 0 !== d.type && "orientationchange" === d.type ? l.classList.contains("item-is-fixed") ? setTimeout((function() {
                            h.style.height = Math.floor(h.offsetHeight + l.offsetHeight) + "px"
                        }), 21) : setTimeout((function() {
                            h.style.height = h.offsetHeight + "px"
                        }), 21) : h.style.height = h.offsetHeight + "px") : h.classList.contains("site-header-inner-wrap") ? (h.style.height = null, h.style.height = h.offsetHeight + "px") : h.style.height = l.offsetHeight + "px"), "true" === w) {
                        var y = l.getAttribute("data-shrink-height");
                        if (y) {
                            if ("true" === m)
                                if (window.scrollY > r) var v = Math.floor(Math.floor(s) - Math.floor(c) + Math.floor(p));
                                else v = Math.floor(s - c);
                            else v = Math.floor(s - c);
                            var b = l.querySelector(".custom-logo"),
                                k = l.querySelector(".kadence-sticky-logo"),
                                L = l.querySelector(".site-main-header-inner-wrap"),
                                S = parseInt(L.getAttribute("data-start-height"));
                            if (S || (L.setAttribute("data-start-height", L.offsetHeight), S = L.offsetHeight), window.scrollY <= v) L.style.height = S + "px", L.style.minHeight = S + "px", L.style.maxHeight = S + "px", b && (b.style.maxHeight = "100%"), k && (k.style.maxHeight = "100%");
                            else if (window.scrollY > v) {
                                var x = Math.max(y, S - (window.scrollY - (s - c)));
                                L.style.height = x + "px", L.style.minHeight = x + "px", L.style.maxHeight = x + "px", b && (b.style.maxHeight = x + "px"), k && (k.style.maxHeight = x + "px")
                            }
                        }
                    }
                    if ("true" === m) {
                        var A = Math.floor(s - c),
                            E = window.scrollY,
                            q = l.offsetHeight,
                            T = r - E,
                            M = window.getComputedStyle(l).getPropertyValue("transform").match(/(-?[0-9\.]+)/g);
                        if (M && void 0 !== M[5] && M[5]) var H = parseInt(M[5]) + T;
                        else H = 0;
                        var C = E > r;
                        if (E <= A) l.style.transform = "translateY(0px)";
                        else if (C) l.classList.add("item-hidden-above"), l.style.transform = "translateY(" + (Math.abs(H) > q ? -q : H) + "px)";
                        else {
                            A = Math.floor(s - c);
                            l.style.transform = "translateY(" + (H > 0 ? 0 : H) + "px)", l.classList.remove("item-hidden-above")
                        }
                        r = E
                    } else A = Math.floor(s - c);
            ...
            if ((e || t) && (window.addEventListener("resize", u, !1), window.addEventListener("scroll", u, !1), window.addEventListener("load", u, !1), window.addEventListener("orientationchange", u), "complete" === document.readyState && u("updateActive"), document.body.classList.contains("woocommerce-demo-store") && document.body.classList.contains("kadence-store-notice-placement-above"))) {
                d = document.querySelector(".woocommerce-store-notice"), l = e => {
                    u("updateActive")
                }, c = {
